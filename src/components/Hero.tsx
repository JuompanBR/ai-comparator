...
export const Hero = () => {
    return (
        <>
            ...
            <p className="text-slate-600 text-lg lg:text-2xl font-normal leading-normal">The <span className="underline text-yellow-600 font-bold">Best tool</span> to find your best fit for all conversational <br/> SaaS AI products.</p>
            <br />
            <div className="w-full justify-center items-center flex space-x-11">
              ...
              <a href="#how-to" className="rounded-sm py-1.5 px-6 text-amber-700 text-base lg:text-lg font-bold bg-[#e38716]/20 hover:bg-[#e38716]/25 transition-all shadow-xs">How does it work ?</a>
            </div>
          </section>
        </>
    );
