export const HowTo = () => {
    return (
        <>
            <h1 id="how-to" className="text-center font-bold text-[1.78rem] text-slate-800 -mt-5 pb-10">How to use</h1>
            <div className="container mx-auto px-4 relative w-full lg:w-[80%] mt-11">
